...
namespace Karu\Laroute;

use Illuminate\Support\ServiceProvider;
use Karu\Laroute\Console\Commands\LarouteGeneratorCommand;
use Karu\Laroute\Routes\Collection as Routes;
...
class LarouteServiceProvider extends ServiceProvider
{
    ...
    protected function registerGenerator()
    {
        $this->app->bind(
            ...
            'Karu\Laroute\Generators\TemplateGenerator'
        );
    }
    ...
    {
        $this->app->bind(
            'Karu\Laroute\Compilers\CompilerInterface',
            'Karu\Laroute\Compilers\TemplateCompiler'
        );
    }
    ...
    protected function registerCommand()
    {
        $this->app->singleton(
            ...
            function ($app) {
                ...
                $generator  = $app->make('Karu\Laroute\Generators\GeneratorInterface');
